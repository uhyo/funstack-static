...
Your SPA is pre-rendered to static files in the `dist/public` directory, ready to deploy to any static hosting provider. The app hydrates on the client for full SPA interactivity.
