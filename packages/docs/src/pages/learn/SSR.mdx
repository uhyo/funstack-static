...
FUNSTACK Static supports an optional `ssr` mode that pre-renders your App component to HTML at build time. This page explains when to enable this option and what to consider.
...
To make components SSR-capable, defer browser API access to effects or check for the browser environment:
