...
- `adapter` — path to a module that `export default`s the adapter defining the directory / file-name convention. To use the built-in Next.js-like convention, re-export `nextRoutes()`:
