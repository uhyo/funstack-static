...
> **Tip:** For convention-based routing, the `entries` module can be generated from a `pages/` directory using built-in [File-System Routing](/learn/file-system-routing).
