...
Use `fsRoutes` to map pages from the file system to routes, rendered with FUNSTACK Router:
...
See [File-System Routing](/learn/file-system-routing) for a full guide.
